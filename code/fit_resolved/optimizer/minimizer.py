...
bounds = None#[(theta_low[i], theta_high[i]) for i in range(len(theta_high))]
...
print()
print(red_chi(theta_true, y, yerr))

print()
bfgs_min = minimize(red_chi, theta_start, args=(y, yerr), method='L-BFGS-B', bounds=bounds, options={"eps": 1e-10})
print(bfgs_min)
print(bfgs_min.hess_inv.todense())
print()

bfgs_real_min = minimize(red_chi, theta_true, args=(y, yerr), method='L-BFGS-B', bounds=bounds, options={"eps": 1e-10})
print(bfgs_real_min)
print(bfgs_real_min.hess_inv.todense())
print()
