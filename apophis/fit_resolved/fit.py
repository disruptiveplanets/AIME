...
def fit_function(theta, target_length=None):
    if ASTEROIDS_MAX_K == 3:
        if ASTEROIDS_MAX_J == 0:
            ...
            resolved_data = asteroids_3_3.simulate(cadence, theta, radius, 0, False, VELOCITY_MUL)
        ...
        if ASTEROIDS_MAX_J == 0:
            ...
            resolved_data = asteroids_3_2.simulate(cadence, theta, radius, 0, False, VELOCITY_MUL)
