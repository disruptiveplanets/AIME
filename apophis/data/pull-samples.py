...
for fname in os.listdir("../staged/"):
    ...
    while True:
        ...
        out = os.system("scp jdinsmore@txe1-login.mit.edu:~/asteroid-tidal-torque/apophis/code/fit_resolved/{0}-{2}-samples.npy {1}/{0}/{0}-{2}-samples.npy".format(fname, PATH, i))
        if out != 0:
            break
        i += 1
