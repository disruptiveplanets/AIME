...
\begin{figure*}
  ...
  % \includegraphics[width=0.3\textwidth]{figs/asym-ell-diff-harmonic.pdf}\hfill\hspace{0.3\textwidth}
  ...
  % \includegraphics[width=0.3\textwidth]{figs/asym-ell-ratio-likelihood.pdf}\hfill
  % \includegraphics[width=0.3\textwidth]{figs/asym-ell-ratio-harmonic.pdf}\hfill\hspace{0.3\textwidth}
...
\begin{figure*}
  ...
  % \includegraphics[width=0.3\textwidth]{figs/blob-ratio-likelihood.pdf}\hfill
  % \includegraphics[width=0.3\textwidth]{figs/blob-ratio-harmonic.pdf}\hfill\hspace{0.3\textwidth}
