...
\begin{equation}
  f[\rho(\bm r)] \propto \prod_i \frac{\delta_i^2}{2\sigma^2}
\end{equation}
where $\sigma$ is an irrelevant constant. The The density moments, MOI scale, and mass are 
\begin{equation}
