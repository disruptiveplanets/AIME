...
\jtd{I wanted to talk to Julien about the interpretation of this panel. Because $t_\text{spin} / t_\text{orbit}$, I find it hard to interpret because it's unphysical. Maybe a different type of scan is better? Or I could just stop here and not interpret further.}
...
\section{Posterior uncertainty threshold}
\label{app:sigma-threshold}
