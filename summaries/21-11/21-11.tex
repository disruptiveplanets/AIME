...
\begin{equation}
  \rho(\bm r) = \sum_{\ell, m} D_{\ell m} R_{\ell m}^*(\bm r)
...
\begin{equation}
  K_{\ell', m'} = \sum_{\ell m} \frac{1}{\mu_m a_m^{\ell'}} D_{\ell m} \int_\mathcal{A} d^3 r R_{\ell m}^*(\bm r) R_{\ell' m'}(\bm r)
\end{equation}
...
\begin{equation}
  \sum_{i=1}^N \bm x_i \mu_i = \mu_0 \bm x_0
